...
% adicionar exemplos 2.3 e imagem no 1.2
...
Figure \ref{fig:after} illustrates some examples of the results obtained with this implementation.
...
\captionsetup{labelformat=empty}
    \centering
    \includegraphics[width=1\textwidth]{after11}
    \caption{Example 1}
    \label{fig:after11}
\end{subfigure}
\begin{subfigure}{.48\textwidth}
  \captionsetup{labelformat=empty}
    \centering
    \includegraphics[width=1\textwidth]{after12}
    \caption{Result}
    \label{fig:after12}
\end{subfigure}
...
\begin{subfigure}{.48\textwidth}
  \captionsetup{labelformat=empty}
    \centering
    \includegraphics[width=1\textwidth]{after21}
    \caption{Example 2}
    \label{fig:after21}
\end{subfigure}
\begin{subfigure}{.48\textwidth}
  \captionsetup{labelformat=empty}
    \centering
    \includegraphics[width=1\textwidth]{after22}
    \caption{Result}
    \label{fig:after22}
\end{subfigure}
...
\begin{subfigure}{.48\textwidth}
  \captionsetup{labelformat=empty}
    \centering
    \includegraphics[width=1\textwidth]{after31}
    \caption{Example 3}
    \label{fig:after31}
\end{subfigure}
\begin{subfigure}{.48\textwidth}
  \captionsetup{labelformat=empty}
    \centering
    \includegraphics[width=1\textwidth]{after32}
    \caption{Result}
    \label{fig:after32}
\end{subfigure}

\caption{Three examples that demonstrate the dependency mechanism}
\label{fig:after}
\end{figure}
